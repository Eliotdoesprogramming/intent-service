...
intents = {
    "intent": [
        ...
        "help_request", "help_request", "help_request", "help_request", "help_request",
        "product_inquiry", "product_inquiry", "product_inquiry", "product_inquiry", "product_inquiry",
        "product_inquiry", "product_inquiry", "product_inquiry", "product_inquiry", "product_inquiry",
    ...
    "text": [
        ...
        "good evening", "howdy", "hi there", "greetings", "hello",
        "goodbye", "bye", "see you later", "have a nice day", "take care",
        "bye bye", "farewell", "until next time", "good night", "thanks bye",
        "i need help", "can you assist me", "having trouble with", "support needed", "help please",
        "can someone help", "assistance required", "need support", "got a problem", "help me out",
        "how much does it cost", "what's the price", "tell me about this product", "product details please", "is this item available",
        "do you have this in stock", "what are the features", "product specifications", "when will it ship", "what colors are available",
        "this isn't working", "i'm having issues with", "not satisfied", "product is defective", "poor service",
        "this is unacceptable", "want to file a complaint", "disappointed with", "doesn't work as advertised", "broken on arrival"
    ]
}
...
def test_intent_classifier():
    ...
    # Ensure test_data is pandas DataFrame
